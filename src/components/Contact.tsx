import bg from '../assets/register_bg.webp'

import logoKuberans from '../assets/logoKuberans.webp'
import logoAic from '../assets/logoAicnitte.png'
import logoIdeabaaz from '../assets/ideabazz.png'
    ...
    <section className="w-full bg-black py-14 px-4 sm:px-8" id="contact">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6 mb-10 w-full max-w-xl">
          <button
            className="flex-1 bg-[#2AA5F7] text-white font-semibold px-6 py-4 rounded-full text-lg shadow-lg hover:scale-105 transition cursor-pointer"
          >
            Login for Teachers
          </button>
          <button
            className="flex-1 bg-[#FF9000] text-white font-semibold px-6 py-4 rounded-full text-lg shadow-lg hover:scale-105 transition cursor-pointer"
          >
            Login for Students
          </button>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-lg px-8 py-4 min-w-[230px]">
            ...
            <div className="flex flex-wrap gap-4 justify-center items-center">
              ...
              <img
                src={logoIdeabaaz}
                alt="Ideabaaz Dangal"
                className="h-10 object-contain bg-amber-300"
              />
            </div>
          </div>
        </div>
